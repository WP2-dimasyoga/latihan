...
<html>
<head>
<title>Barcelona Shop - Masuk</title>
<!-- for-mobile-apps -->
	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
				<ul class="phone_email">
					<li><i class="fa fa-phone" aria-hidden="true"></i>Hubungi Kami : +62 857 7921 3272</li>
				</ul>
			</div>
			<div class="w3ls_logo_products_left">
				<h1><a href="index.php">Barcelona Shop</a></h1>
			</div>
...
<div class="footer">
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Kelompok 1 | Web Programming II</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:Barcelonashop@email">Barcelonashop@email</a></li>
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>@ Kelompok 1 | Web Programming II</p>
			</div>
		</div>
